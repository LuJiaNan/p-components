...
const ModeTypeArr: string[] = ["tags", "multiple"];

export declare type ModeType = "tags" | "multiple";
...
export default class SuperSelect extends React.PureComponent<Props, State> {
  isMultiple: false;
  ITEM_HEIGHT: 0;
  visibleDomHeight: 0;
  reactDelta: 0;
  constructor(props: any) {
    ...
    this.isMultiple = ModeTypeArr.includes(mode);
